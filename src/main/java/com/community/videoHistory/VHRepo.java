package com.community.videoHistory;
...
public class VHRepo {
    ...
    private RowMapper<com.bproject.videoHistory.VideoHistory> videoHistoryRowMapper = new RowMapper<VideoHistory>() {
        @Override
        public com.bproject.videoHistory.VideoHistory mapRow(ResultSet rs, int rowNum) throws SQLException {
            return new com.bproject.videoHistory.VideoHistory(
                    rs.getInt("id"),
                    rs.getInt("user_id"),
                    rs.getInt("video_id"),
